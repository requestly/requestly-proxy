...
const harObectCreator_1 = require("./harObectCreator");
class CtxRQNamespace {
    constructor() {
        ...
        this.set_final_request = (proxyToServerRequestOptions) => {
            ...
            this.final_request.requestHarObject = (0, harObectCreator_1.createRequestHarObject)(this.final_request.requestHarObject || {}, proxyToServerRequestOptions);
        };
